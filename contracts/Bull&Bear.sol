...
contract BullBear is ERC721, ERC721Enumerable, ERC721URIStorage, Ownable, KeeperCompatibleInterface {
    ...
    constructor(uint256 intervalArg, address _pricefeed) ERC721("Bull&Bear", "BBTK") {
    ...
    function checkUpkeep(bytes calldata /* checkData */) external override virtual returns (bool upkeepNeeded, bytes memory /*performData */) {
        if (block.timestamp > (interval + lastUpdated)) {
            return (true, bytes(" "));
        }
        return (false, bytes(" "));
    }
    ...
    function performUpkeep(bytes calldata /* performData */ ) external override {
        ...
        if ((block.timestamp - lastUpdated) > interval ) {
